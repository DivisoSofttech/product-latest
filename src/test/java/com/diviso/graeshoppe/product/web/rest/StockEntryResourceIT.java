...
/**
 * Integration tests for the {@link StockEntryResource} REST controller.
 */
@SpringBootTest(classes = {ProductApp.class, TestSecurityConfiguration.class})
public class StockEntryResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static StockEntry createUpdatedEntity(EntityManager em) {
        StockEntry stockEntry = new StockEntry()
