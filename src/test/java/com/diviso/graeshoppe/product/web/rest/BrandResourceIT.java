...
public class BrandResourceIT {
     ...
     *
     * @see com.diviso.graeshoppe.product.repository.search.BrandSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createBrand() throws Exception {
        ...
        assertThat(testBrand.getiDPcode()).isEqualTo(DEFAULT_I_D_PCODE);
    ...
    public void updateBrand() throws Exception {
        ...
        Brand testBrand = brandList.get(brandList.size() - 1);
        assertThat(testBrand.getiDPcode()).isEqualTo(UPDATED_I_D_PCODE);
