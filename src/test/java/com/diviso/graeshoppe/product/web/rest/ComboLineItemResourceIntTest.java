...
/**
 * Test class for the ComboLineItemResource REST controller.
 *
 * @see ComboLineItemResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = ProductApp.class)
public class ComboLineItemResourceIntTest {
    ...
    public void testEntityFromId() {
        assertThat(comboLineItemMapper.fromId(42L).getId()).isEqualTo(42);
