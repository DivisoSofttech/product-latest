...
/**
 * Test class for the EntryLineItemResource REST controller.
 *
 * @see EntryLineItemResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = ProductApp.class)
public class EntryLineItemResourceIntTest {
    ...
    public void testEntityFromId() {
        assertThat(entryLineItemMapper.fromId(42L).getId()).isEqualTo(42);
