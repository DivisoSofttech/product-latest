...
/**
 * Test class for the AuxilaryLineItemResource REST controller.
 *
 * @see AuxilaryLineItemResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = ProductApp.class)
public class AuxilaryLineItemResourceIntTest {
    ...
    public void testEntityFromId() {
        assertThat(auxilaryLineItemMapper.fromId(42L).getId()).isEqualTo(42);
