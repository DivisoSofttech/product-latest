...
public class AuxilaryLineItemResource {
     ...
     *
     * @param auxilaryLineItemDTO the auxilaryLineItemDTO to create
     * @return the ResponseEntity with status 201 (Created) and with body the new auxilaryLineItemDTO, or with status 400 (Bad Request) if the auxilaryLineItem has already an ID
    ...
    public ResponseEntity<AuxilaryLineItemDTO> createAuxilaryLineItem(@RequestBody AuxilaryLineItemDTO auxilaryLineItemDTO) throws URISyntaxException {
        ...
        if (auxilaryLineItemDTO.getId() != null) {
            throw new BadRequestAlertException("A new auxilaryLineItem cannot already have an ID", ENTITY_NAME, "idexists");
        }
     ...
     *
     * @param auxilaryLineItemDTO the auxilaryLineItemDTO to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated auxilaryLineItemDTO,
     * or with status 400 (Bad Request) if the auxilaryLineItemDTO is not valid,
     * or with status 500 (Internal Server Error) if the auxilaryLineItemDTO couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/auxilary-line-items")
    public ResponseEntity<AuxilaryLineItemDTO> updateAuxilaryLineItem(@RequestBody AuxilaryLineItemDTO auxilaryLineItemDTO) throws URISyntaxException {
     ...
     * @return the ResponseEntity with status 200 (OK) and the list of auxilaryLineItems in body
     */
     ...
     *
     * @param id the id of the auxilaryLineItemDTO to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the auxilaryLineItemDTO, or with status 404 (Not Found)
     */
     ...
     *
     * @param id the id of the auxilaryLineItemDTO to delete
    ...
    /**
     * SEARCH  /_search/auxilary-line-items?query=:query : search for the auxilaryLineItem corresponding
     * to the query.
     *
     * @param query the query of the auxilaryLineItem search
     * @param pageable the pagination information
     * @return the result of the search
     */
    @GetMapping("/_search/auxilary-line-items")
    public ResponseEntity<List<AuxilaryLineItemDTO>> searchAuxilaryLineItems(@RequestParam String query, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generateSearchPaginationHttpHeaders(query, page, "/api/_search/auxilary-line-items");
        return ResponseEntity.ok().headers(headers).body(page.getContent());
    }
