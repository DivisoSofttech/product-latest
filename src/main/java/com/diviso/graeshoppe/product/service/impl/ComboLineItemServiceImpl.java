...
public class ComboLineItemServiceImpl implements ComboLineItemService {
    ...
    public ComboLineItemServiceImpl(ComboLineItemRepository comboLineItemRepository, ComboLineItemMapper comboLineItemMapper, ComboLineItemSearchRepository comboLineItemSearchRepository) {
    ...
    public ComboLineItemDTO save(ComboLineItemDTO comboLineItemDTO) {
        ...
        ComboLineItem comboLineItem = comboLineItemMapper.toEntity(comboLineItemDTO);
        comboLineItem = comboLineItemRepository.save(comboLineItem);
        ComboLineItemDTO result = comboLineItemMapper.toDto(comboLineItem);
        comboLineItemSearchRepository.save(comboLineItem);
        return result;
    }
    ...
    public Page<ComboLineItemDTO> findAll(Pageable pageable) {
        ...
        return comboLineItemRepository.findAll(pageable)
            .map(comboLineItemMapper::toDto);
    }
    ...
    public Optional<ComboLineItemDTO> findOne(Long id) {
        ...
        return comboLineItemRepository.findById(id)
            .map(comboLineItemMapper::toDto);
    }
    ...
    public Page<ComboLineItemDTO> search(String query, Pageable pageable) {
        ...
        return comboLineItemSearchRepository.search(queryStringQuery(query), pageable)
            .map(comboLineItemMapper::toDto);
    }
}
