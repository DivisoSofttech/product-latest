...
public class AuxilaryLineItemServiceImpl implements AuxilaryLineItemService {
	...
	public AuxilaryLineItemServiceImpl(AuxilaryLineItemRepository auxilaryLineItemRepository,
			AuxilaryLineItemMapper auxilaryLineItemMapper,
			AuxilaryLineItemSearchRepository auxilaryLineItemSearchRepository) {
	...
	public Page<AuxilaryLineItemDTO> findAll(Pageable pageable) {
		...
		return auxilaryLineItemRepository.findAll(pageable).map(auxilaryLineItemMapper::toDto);
	}
	...
	public Optional<AuxilaryLineItemDTO> findOne(Long id) {
		...
		return auxilaryLineItemRepository.findById(id).map(auxilaryLineItemMapper::toDto);
	}
